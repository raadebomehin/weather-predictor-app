...
st.set_page_config(page_title='Weather P', page_icon="rainbow:")
...
if(st.button("SUBMIT")):
    try:
        ...
        ), cells=dict(values=[dates, maxtemp, mintemp, rain, cloud, humd], line_color='black', fill_color=['darkgoldenrod', ['palegreen', '#fdbe72']*7], font_size=14, height=32
        )
        )])
        ...
        line_color='black',fill_color=['darkgoldenrod',['palegreen', '#fdbe72']*7], font_size=14,height=36))])
